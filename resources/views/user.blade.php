        ...
        <div class="row">
            <div class="col-5">
                <div class="form-group">
                    ...
                    <input name="opened_from" type="time" class="form-control" value="{{(!$user)?old('opened_from'):$user->opened_from}}" required>
                    @error('opened_from')
                    <div class="alert alert-danger">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="col-5">
                <div class="form-group">
                    ...
                    <input name="opened_to" type="time" class="form-control" value="{{(!$user)?old('opened_to'):$user->opened_to}}" required>
                    @error('opened_to')
                    <div class="alert alert-danger">{{$message}}</div>
                    @enderror
                </div>
